...
if deployment == "DEV":
    ...
    SI = '0 0 * * *'
SQL = f'''select DATE, TIME, WERKS, BTRTL, ORGEH, LNAME, SNAME, ABBRV, OPRNT, CHPER, ZTYPE, SENDD
                from {SCHEMA_source}.organizational_unit_actual_f('{EXEC_DATE}')'''
...
with DAG(
    ...
    transfer_cos_smb = Postgres2SMB_decrypt(
        ...
        file_format='xml',
        template_excel_xml='./template/orgunit_new.xml',
        encoding='utf-8',
