...
from Postgres2SMB_cos import Postgres2SMB_cos
...
with DAG(
    ...
    transfer_cos_smb = Postgres2SMB_decrypt(
        ...
        file_name='user_new',
        file_format='xml',
        template_excel_xml='./template/user_new.xml',
        encoding='utf-8',
    ...
    log_sensor >> log_start >> getid >> check_system_source >> check_system_target >> transfer_cos_smb >> transfer_cos_smb_xlsx  # идеальный сценарий
