...
with DAG(
    ...
    #     qrows = records[0][0]
    #     context['task_instance'].xcom_push(key='qrows_my', value=qrows)
    #     if qrows >= 1:
    ...
    transfer_cos_smb = Postgres2SMB(
        ...
        sql=f'''select WERKS, BTRTL, MOFID, BTEXT, NAME1 from {SCHEMA_source}.personal_section_inf_on_request_v;''',
